...
extern int
TclModelBuilder_addTaperedForceBeamColumn(ClientData, Tcl_Interp *, int, TCL_Char **, Domain*, TclModelBuilder *);
			      ...
			      Domain *theTclDomain, TclModelBuilder *theTclBuilder)
{
  ...
  */
  ...
  {
	int result = TclModelBuilder_addTaperedForceBeamColumn(clientData, interp, argc, argv, theTclDomain, theTclBuilder);
	return result;

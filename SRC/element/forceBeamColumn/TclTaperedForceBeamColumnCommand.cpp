                                          ...
                                          theTclBuilder)
{
	...
	printf("Before checking the iteration\n");
        ...
        if (ndm == 3) 
		{
			...
			{
				theElement = new TaperedDispBeamColumnSmoothing3d(eleTag, iNode, jNode, nIP, sections, *beamIntegr, 
																  *theTransf3d, mass);
			}
			else 
			{
				theElement = new ForceBeamColumn3d(eleTag, iNode, jNode, nIP, sections, *beamIntegr,
	...
	{
		theElement = new TaperedDispBeamColumnSmoothing3d(eleTag, iNode, jNode, numSections, sections, *beamIntegr, 

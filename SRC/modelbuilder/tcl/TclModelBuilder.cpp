...
TclModelBuilder::~TclModelBuilder()
{
  ...
  Tcl_DeleteCommand(theInterp, "TaperedFiber"); // Added by Brighton Laiman: University of California, San Diego  Tcl_DeleteCommand(theInterp, "geomTransf");
...
// Brighton Laiman: University of California, San Diego
int
TclCommand_addRemoTaperedFiber(ClientData clientData, Tcl_Interp *interp, int argc, TCL_Char **argv)
{
	return TclCommand_addTaperedFiber(clientData, interp, argc,argv, theTclBuilder);
} 
// [END] Brighton Laiman: University of California, San Diego

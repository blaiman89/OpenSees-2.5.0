...
Matrix PDeltaCrdTransf3d14::Tlg(12,12);
Matrix PDeltaCrdTransf3d14::kg(12,12);

void* OPS_PDeltaCrdTransf3d14()
{
	...
	return new PDeltaCrdTransf3d14(tag,vec,jntOffsetI,jntOffsetJ);
}
...
void
	PDeltaCrdTransf3d14::compTransfMatrixLocalGlobal(Matrix &Tlg) 
{
...
const Matrix &
PDeltaCrdTransf3d14::getGlobalMatrixFromLocal(const Matrix &ml)
{

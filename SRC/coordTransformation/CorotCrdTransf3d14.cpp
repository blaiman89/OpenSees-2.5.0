...
Matrix CorotCrdTransf3d14::Tlg(12, 12);
Matrix CorotCrdTransf3d14::kg(12, 12);

void* OPS_CorotCrdTransf3d14()
{
	...
	return new CorotCrdTransf3d14(tag,vec,jntOffsetI,jntOffsetJ);
}
...
void
CorotCrdTransf3d14::compTransfMatrixLocalGlobal(Matrix &Tlg)
{
...
const Matrix &
	CorotCrdTransf3d14::getGlobalMatrixFromLocal(const Matrix &ml)
{

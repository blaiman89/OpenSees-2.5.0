...
#include <LinearCrdTransf3d14.h>  // Added for Tapered Study
#include <PDeltaCrdTransf3d14.h>  // Added for Tapered Study
#include <CorotCrdTransf3d14.h>   // Added for Tapered Study
  ...
  
{
  ...
  // Block the error messages for when using 7 DOFs
  /*
  else {
  ...
  */
	...
	if (strcmp(argv[1], "Linear14") == 0)
	  crdTransf3d = new LinearCrdTransf3d14(crdTransfTag, vecxzPlane);

	else if (strcmp(argv[1], "PDelta14") == 0)
	  crdTransf3d = new PDeltaCrdTransf3d14(crdTransfTag, vecxzPlane, jntOffsetI, jntOffsetJ);

	else if (strcmp(argv[1],"Corotational14") == 0)
	  crdTransf3d = new CorotCrdTransf3d14(crdTransfTag, vecxzPlane, jntOffsetI, jntOffsetJ);

	// END OF CODE ADDITIONS

	else {
	  opserr << "WARNING TclElmtBuilder - addGeomTransf14 - invalid Type (DOF 7)\n";
	  return TCL_ERROR;
	}

	if (crdTransf3d == 0) {
	  opserr << "WARNING TclElmtBuilder - addGeomTransf14 - ran out of memory to create geometric transformation object\n";
	  return TCL_ERROR;
	}

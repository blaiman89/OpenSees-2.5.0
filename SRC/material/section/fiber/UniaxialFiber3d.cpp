...
UniaxialFiber3d::UniaxialFiber3d(int tag, UniaxialMaterial &theMat, double Area, const Vector &position, double dvalue, double tp)
								 :Fiber(tag, FIBER_TAG_Uniaxial3d), theMaterial(0), area(Area), dValue(dvalue), tPlate(tp)
{
	theMaterial = theMat.getCopy();  // get a copy of the MaterialModel
